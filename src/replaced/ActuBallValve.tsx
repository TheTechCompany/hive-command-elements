...
const SvgActuBallValve = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="url(#actu_ball_valve_svg__a)"
    ...
    <path
      fill="url(#actu_ball_valve_svg__b)"
    ...
    <circle
      fill="url(#actu_ball_valve_svg__c)"
      cx={50.09}
      cy={67.22}
      r={16.66}
    />
    ...
    <path
      ...
      strokeMiterlimit={10}
      d="M50.09 46.96V19.88"
    />
    <radialGradient
      id="actu_ball_valve_svg__d"
      cx={50.094}
      cy={19.245}
      r={5.073}
      gradientUnits="userSpaceOnUse"
    ...
    <path
      fill="none"
      stroke="url(#actu_ball_valve_svg__d)"
      strokeWidth={3}
      strokeLinecap="round"
      strokeMiterlimit={10}
      d="M44.58 19.24h11.03"
    />
    <radialGradient
      id="actu_ball_valve_svg__e"
      cx={50.094}
      cy={19.245}
      r={7.09}
      gradientUnits="userSpaceOnUse"
    ...
    <path
      fill="url(#actu_ball_valve_svg__e)"
      d="M44.58 23.02c-2.08 0-3.77-1.69-3.77-3.77s1.69-3.77 3.77-3.77h11.03c2.08 0 3.77 1.69 3.77 3.77s-1.69 3.77-3.77 3.77H44.58z"
    />
    <path
      fill="#4C4C4D"
      d="M55.61 16.97c1.26 0 2.27 1.02 2.27 2.27s-1.02 2.27-2.27 2.27H44.58c-1.26 0-2.27-1.02-2.27-2.27s1.02-2.27 2.27-2.27h11.03m0-3H44.58c-2.91 0-5.27 2.37-5.27 5.27s2.37 5.27 5.27 5.27h11.03c2.91 0 5.27-2.37 5.27-5.27s-2.36-5.27-5.27-5.27z"
    />
  </svg>
);

export default SvgActuBallValve;
