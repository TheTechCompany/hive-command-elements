...
const Pump = (props) => {
    ...
    console.log("Pump props", (_a = props.options) === null || _a === void 0 ? void 0 : _a.fill);
    return React.createElement("svg", { onClick: (_b = props.options) === null || _b === void 0 ? void 0 : _b.onClick, id: "pump_svg__Layer_1", xmlns: "http://www.w3.org/2000/svg", x: 0, y: 0, viewBox: "0 0 283.46 283.46", xmlSpace: "preserve" },
        React.createElement("style", null, `
      .pump_svg__st0 {
        fill: #4d4d4e;
      }
      .pump_svg{
        fill:${((_c = props.options) === null || _c === void 0 ? void 0 : _c.fill) || (!((_d = props.options) === null || _d === void 0 ? void 0 : _d.stroke)) ? "#4d4d4e" : 'none'}
      }
    `),
        React.createElement("path", { style: {
                fill: ((_e = props.options) === null || _e === void 0 ? void 0 : _e.color) || '#4d4d4e'
        ...
        React.createElement("path", { style: {
                fill: (_f = props.options) === null || _f === void 0 ? void 0 : _f.fill,
                stroke: (_g = props.options) === null || _g === void 0 ? void 0 : _g.stroke,
                strokeWidth: ((_h = props.options) === null || _h === void 0 ? void 0 : _h.stroke) ? '5px' : undefined
