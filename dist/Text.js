...
const Text = (props) => {
    ...
    return (react_1.default.createElement(material_1.Box, { sx: {
        ...
        react_1.default.createElement(material_1.Typography, { fontWeight: ((_f = props.options) === null || _f === void 0 ? void 0 : _f.bold) ? 'bold' : undefined, fontSize: 'small' }, ((_g = props.options) === null || _g === void 0 ? void 0 : _g.text) || props.children || "Text")));
};
exports.Text = Text;
